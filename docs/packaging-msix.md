...
```powershell
powershell -ExecutionPolicy Bypass -File packaging/scripts/build-msix-x64.ps1 -Version 1.2.0.0
powershell -ExecutionPolicy Bypass -File packaging/scripts/build-msix-arm64.ps1 -Version 1.2.0.0
```
...
```powershell
Add-AppxPackage -Path DLNAScreenCast_1.2.0.0.msixbundle -AllowUnsigned
```
